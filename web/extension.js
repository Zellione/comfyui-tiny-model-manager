...
function makeToggle(checked, setter) {
  ...
  track.style.cssText = 'position:absolute;inset:0;border-radius:11px;transition:background .2s';
...
app.registerExtension({
  ...
  settings: [
    ...
    },
    {
      ...
      defaultVal: false,
      tooltip:
        'When enabled, newly downloaded models are placed in <type>/<base-model>/<filename> automatically.',
      async onChange(value) {
        if (!_initialized) return;
